...
public class GeminiService {
    ...
    public PostGeminiResult prediction(MultipartFile image) {
        ...
        try (VertexAI vertexAi = new VertexAI("gdsc-seoultech", "asia-northeast3");) {
            ...
            PostGeminiResult postGeminiResult = objectMapper.readValue(text, PostGeminiResult.class);
            return postGeminiResult;
